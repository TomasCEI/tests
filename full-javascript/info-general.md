...
en cualquier sitio web, podemos abrir la consola de desarrollador con F12 o Ctrl+Shift+I
...
Debe mostrar por consola y en pantalla la cantidad de productos en el carrito.
